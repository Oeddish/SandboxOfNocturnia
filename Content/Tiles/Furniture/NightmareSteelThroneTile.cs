...
public class NightmareSteelThroneTile : ModTile
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        // Names
        AddMapEntry(new Color(100, 50, 150), Language.GetText("MapObject.Throne")); // Purple-ish for a regal look
    ...
    public override void MouseOver(int i, int j)
    {
        ...
        player.cursorItemIconID = ModContent.ItemType<NightmareSteelThrone>();
