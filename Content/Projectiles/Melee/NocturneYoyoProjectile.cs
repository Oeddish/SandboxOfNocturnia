...
using FragmentsOfNocturnia.Content.Items.Tools;
using FragmentsOfNocturnia.Content.Dusts;

namespace FragmentsOfNocturnia.Content.Projectiles.Melee
{
    internal class NocturneYoyoProjectile : ModProjectile
    {
        ...
        public override void PostAI()
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<NocturneDust>()); // Makes the projectile emit dust.
            }
        }
    }
}