...
{
    internal class NocturneYoyo : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.damage = 110; // The amount of damage the item does to an enemy or player.
            ...
            Item.shoot = ModContent.ProjectileType<NocturneYoyoProjectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType<NocturniumBar>(), 10);
